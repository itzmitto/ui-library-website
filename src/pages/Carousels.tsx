...
const sidebarItems = [
  ...
  { label: "Carousels", path: "/elements/carousels", active: true },
...
type CarouselItem = (typeof carousels)[0];
...
export default function Carousels() {
  ...
  const totalRows = Math.ceil(carousels.length / columns);
  ...
  const endIndex = Math.min(carousels.length, endRow * columns);

  const visibleCarousels = carousels.slice(startIndex, endIndex);
    ...
    <div className="all-page">
      ...
      <div className="all-layout">
        ...
        <main className="all-main">
          ...
          >
            {visibleCarousels.map((item, offset) => {
